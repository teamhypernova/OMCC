...
namespace OMCC.Plugins.GameManager
{
    ...
    {
        public MinecraftProfile(MinecraftVersion version, ArgumentsInfo args, AssetIndexDownloadInfo assetIndex, ClientDownloadInfo client, string id, JavaVersion javaVersion, List<Library> libraries, string mainClass, string type)
        {
            Version = version;
            Arguments = args;
        ...
        public static MinecraftProfile Parse(MinecraftVersion version)
        {
            ...
            var args = ArgumentsInfo.Parse(json);
            ...
            return new MinecraftProfile(version, args, assets, client, id, javaVersion, libs, mainCls, type);
        }
    }
}
